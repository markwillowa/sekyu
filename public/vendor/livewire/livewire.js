...
${expression ? 'Expression: "' + expression + '"\n\n' : ""}`, el);
  ...
  function warnAboutMissingPlugins() {
    let pluginDirectives = [
      ["framework", "dialog", ["[x-dialog], [x-popover]"]],
  ...
  function isCheckbox(el) {
    return el.type === "checkbox" || el.localName === "framework-checkbox" || el.localName === "framework-switch";
  }
  function isRadio(el) {
    return el.type === "radio" || el.localName === "framework-radio";
  }
